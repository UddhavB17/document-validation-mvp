"""Anomaly collection and pipeline outcome helpers."""
...
def _collect_pipeline_anomalies(
    *,
    application_id: int,
    pages: list[dict[str, Any]],
    ground_truth: dict[str, Any],
    ...
    """Run checklist checks and convert processing failures into anomalies."""
    ...
    return anomalies, processing_error_anomalies
