...
def seed_settings(connection: sqlite3.Connection) -> None:
    defaults = [
        ...
        ("llm_api_key", "", "str", "llm", "LLM API Key", "API Key for external cloud LLM provider."),
        ("llm_api_key_enabled", "false", "bool", "llm", "Enable LLM API Key Usage", "Toggle whether to use the configured LLM API Key."),
        ("ocr_api_key", "", "str", "ocr", "OCR API Key", "API Key for external cloud OCR services."),
        ("ocr_api_key_enabled", "false", "bool", "ocr", "Enable OCR API Key Usage", "Toggle whether to use the configured OCR API Key."),
