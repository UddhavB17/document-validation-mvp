...
def test_worklist_uses_batched_repository_queries(tmp_path, monkeypatch) -> None:
    ...
    with patch("services.review.worklist.load_validation_results_by_application_ids") as load_anomalies:
        with patch("services.review.worklist.load_pipeline_progress_by_application_ids") as load_progress:
